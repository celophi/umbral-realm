...
//            loginService.Setup(m => m.DoesAccountExist(packet.Account.Text)).Returns(Task.FromResult(false));
//            loginService.Setup(m => m.BuildLoginRejectedPacket()).Returns(response);
...
//            var loginService = new Mock<ILoginService>();
//            loginService.Setup(m => m.IsLoggedIn(packet.Account.Text)).Returns(false);
//            loginService.Setup(m => m.DoesAccountExist(packet.Account.Text)).Returns(Task.FromResult(true));
